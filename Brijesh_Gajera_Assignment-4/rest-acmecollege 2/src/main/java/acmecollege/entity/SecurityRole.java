...
@NamedQuery( name = SecurityRole.FIND_USER_ROLE, query = "SELECT sr FROM SecurityRole sr WHERE sr.roleName = :roleName")
@NamedQuery( name = SecurityRole.SECURITY_ROLE_FIND_ID, query = "SELECT sr FROM SecurityRole sr WHERE sr.id = :param1")
public class SecurityRole implements Serializable {
    /** Explicit set serialVersionUID */
    private static final long serialVersionUID = 1L;
    
    public static final String FIND_USER_ROLE = "SecurityRole.findRole";
    public static final String SECURITY_ROLE_FIND_ID = "SecurityRole.findId";
